...
df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver',from_date='01/12/2019',to_date='21/09/2020', country = "India")
...
zscore = pd.DataFrame(stats.zscore(df['Close'])) 
print(zscore.tail(30))
