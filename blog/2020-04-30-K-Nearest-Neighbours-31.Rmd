...
Manhattan distance (or block distance) appropriate when we have a discrete data set and the Euclidean distance is appropriate when we have continuous numerical variables.
