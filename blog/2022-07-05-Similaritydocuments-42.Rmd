...
This blog makes use of the Latent Symentic index method to findout to access the level at which a given course outcome relates or significant to a set of program outcomes for a given program. 
