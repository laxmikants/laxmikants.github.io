...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='09/10/2019', to_date='22/01/2022')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='09/10/2019', to_date='22/01/2022')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver Micro',from_date='09/10/2019',to_date='22/01/2022', country = "India")
