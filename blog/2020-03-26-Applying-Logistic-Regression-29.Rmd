...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='01/02/2020', to_date='02/10/2021')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='01/02/2020', to_date='02/10/2021')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver Micro',from_date='01/02/2020',to_date='02/10/2021', country = "India")
...
if(predict == -1):
  if(lclose > s1 and lclose < s2):
    print('sell at ', s2, 'with target at ', s1)
  if(lclose > s2 and lclose < s3):
    print('sell at ', s3, 'with target at ', s2)
  if(lclose > s3 and lclose < pp):
    print('sell at ', pp, 'with target at ', s3)
...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='01/01/2020', to_date='02/10/2021')

df = investpy.get_commodity_historical_data(commodity='Silver', from_date='01/01/2020', to_date='02/10/2021')
