...
df = investpy.commodities.get_commodity_historical_data(stock='ABC',from_date='01/11/2019',to_date='14/08/2020', country = "India")
```


```{python, echo = FALSE}

usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='09/12/2020', to_date='10/09/2022')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='09/12/2020', to_date='10/09/2022')
dfusd1 = investpy.get_commodity_historical_data(commodity='Silver', from_date='08/09/2022', to_date='10/09/2022')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver Micro',from_date='09/12/2021',to_date='10/09/2022', country = "India")
...
```{python,echo = FALSE}
data2 = investpy.pivot_points(name='MCX Silver Micro', country='India', product_type='commodity', interval='daily')
print(data2.tail(5))

data3 = investpy.technical_indicators(name='MCX Silver Micro', country='India', product_type='commodity', interval='daily')
print(data3.head())
...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='09/12/2019', to_date='07/07/2022')

df = investpy.get_commodity_historical_data(commodity='Silver', from_date='09/12/2019', to_date='07/07/2022')
...
comp['y_pred'] = y_pred
print(comp.tail(5))
predictxagusd = model.predict(X_test.tail(1))
print(predictxagusd)

if(predictxagusd  == -1):
  print("AMO Sell ", lclose - 100)
else:
  print("AMO Buy ", lclose + 100)
