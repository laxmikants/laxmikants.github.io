...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='09/10/2019', to_date='19/03/2022')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='09/10/2019', to_date='19/03/2022')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver Micro',from_date='09/10/2019',to_date='19/03/2022', country = "India")
...
print(df[['ATR','20dayEMA','ATRdiff']].tail().mean())
```
...
data2 = investpy.pivot_points(name='MCX Silver Micro', country='India', product_type='commodity', interval='1hour')
print(data2.iloc[1])

data3 = investpy.technical_indicators(name='MCX Silver Micro', country='India', product_type='commodity', interval='1hour')
print(data3.head())
