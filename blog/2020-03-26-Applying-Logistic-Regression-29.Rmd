...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='01/01/2015', to_date='13/01/2021')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='01/01/2015', to_date='13/01/2021')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver Micro',from_date='01/01/2015',to_date='13/01/2021', country = "India")
...
df2['SL'] = np.where((df2['Str'] == 'Buy'),df2['Low'], df2['High'])
...
df = quandl.get("MCX/SIU2020",start_date = "2020-05-04", end_date = "2020-09-03")  
df.dropna()  
print(df.tail())
...
```{r load-all-libraries, echo=FALSE, warning=FALSE, message=FALSE,eval=TRUE}
library(Quandl)
library(quantmod)
library(prophet)
...
daily_silver = Quandl("CHRIS/MCX_SI1",collapse="daily",start_date="2020-01-01",end_date = "2021-01-13",type="raw")
