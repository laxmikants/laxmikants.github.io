...
```{python, echo = FALSE}
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='01/12/2019', to_date='01/01/2021')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='01/12/2019', to_date='01/01/2021')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver',from_date='01/12/2019',to_date='01/01/2021', country = "India")
