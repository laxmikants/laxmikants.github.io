...
```{python, echo = FALSE}
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='01/12/2019', to_date='30/12/2020')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='01/12/2019', to_date='30/12/2020')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver',from_date='01/12/2019',to_date='30/12/2020', country = "India")
...
print(df['PCT_Change'].max())
print(df['PCT_Change'].mean())
print(df['PCT_Change'].min())
...
daily_silver = Quandl("CHRIS/MCX_SI1",collapse="daily",start_date="2020-01-01",end_date = "2020-12-28",type="raw")
