...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='22/03/2013', to_date='22/03/2022')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='22/03/2013', to_date='22/03/2022')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver Micro',from_date='22/03/2013',to_date='22/03/2022', country = "India")
...
print(df[['ATR','20dayEMA','ATRdiff']].tail(7))
```
...
if(predict == 1):
  print('Buy at : ', (data2_hr.iloc[1,4] + data2_dl.iloc[1,4] + data2_hr.iloc[1,3] + data2_dl.iloc[1,3])/4)
else:
  print('Sell at: ', (data2_hr.iloc[1,4] + data2_dl.iloc[1,4] + data2_hr.iloc[1,3] + data2_dl.iloc[1,3])/4)
