...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='09/10/2019', to_date='12/10/2021')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='09/10/2019', to_date='12/10/2021')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver Micro',from_date='09/10/2019',to_date='12/10/2021', country = "India")
...
s1 = data2.iloc[0,1].astype(int)
s2 = data2.iloc[0,2].astype(int)
s3 = data2.iloc[0,3].astype(int)
pp = data2.iloc[0,4].astype(int)
r1 = data2.iloc[0,5].astype(int)
r2 = data2.iloc[0,6].astype(int)
r3 = data2.iloc[0,7].astype(int)
...
if(predict == -1):
  if(lclose > s1 and lclose < pp):
    print('sell at ', pp, 'with target at ', s1)
  if(lclose > s2 and lclose < s1):
    print('sell at ', s1, 'with target at ', s2)
  if(lclose > s3 and lclose < s2):
    print('sell at ', s2, 'with target at ', s3)
  if(lclose > pp and lclose < r1):
    print('sell at ', r1, 'with target at ', pp)
  if(lclose > r1 and lclose < r2):
    print('sell at ', r2, 'with target at ', r1)
  if(lclose > r2 and lclose < r3):
    print('sell at ', r3, 'with target at ', r2)
    
    
if(predict == 1):
  if(lclose > pp and lclose < r1):
    print('buy at ', pp, 'with target at ', r1)
  if(lclose > r1 and lclose < r2):
    print('buy at ', r1, 'with target at ', r2)
  if(lclose > r2 and lclose < r3):
    print('buy at ', r2, 'with target at ', r3)
  if(lclose > s1 and lclose < pp):
    print('buy at ', s1, 'with target at ', pp)
  if(lclose > s2 and lclose < s1):
    print('buy at ', s2, 'with target at ', s1)
  if(lclose > s3 and lclose < s2):
    print('buy at ', s3, 'with target at ', s2)
...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='01/01/2020', to_date='07/10/2021')

df = investpy.get_commodity_historical_data(commodity='Silver', from_date='01/01/2020', to_date='07/10/2021')
