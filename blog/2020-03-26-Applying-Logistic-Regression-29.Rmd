...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='09/10/2019', to_date='16/04/2022')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='09/10/2019', to_date='16/04/2022')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver Micro',from_date='09/10/2019',to_date='16/04/2022', country = "India")
...
if(lclose < data2_dl.iloc[1,4]):
  print("Bearish daily: Sell at ",data2_dl.iloc[1,4])
else:
  print("Bullish at daily: Buy at ", data2_dl.iloc[1,4])
  
if(lclose > data2_hr.iloc[1,4]):
  print("Bullish hourly: Buy at ", data2_hr.iloc[1,4])
else:
  print("Bearish hourly: Sell at ", data2_hr.iloc[1,4])
  

if(predict == 1):
    print('Pridiction: Buy at ', data2_dl.iloc[1,4])
else:
