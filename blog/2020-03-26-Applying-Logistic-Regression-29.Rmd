...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='01/01/2020', to_date='05/08/2021')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='01/01/2020', to_date='05/08/2021')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver Micro',from_date='01/01/2020',to_date='05/08/2021', country = "India")
