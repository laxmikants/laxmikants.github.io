...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='01/01/2010', to_date='12/01/2021')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='01/01/2010', to_date='12/01/2021')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver Micro',from_date='01/01/2010',to_date='12/01/2021', country = "India")
...
daily_silver = Quandl("CHRIS/MCX_SI1",collapse="daily",start_date="2020-01-01",end_date = "2021-01-11",type="raw")
