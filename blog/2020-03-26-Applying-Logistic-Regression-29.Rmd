...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='01/02/2020', to_date='25/09/2021')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='01/02/2020', to_date='25/09/2021')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver Micro',from_date='01/02/2020',to_date='25/09/2021', country = "India")
...
if(dfs.iloc[-1]['Open'] == dfs.iloc[-1]['Low']):
  print('Open Low Strategy ', 'Buy above', dfs[-2]['High'] )

if(dfs.iloc[-1]['Open'] == dfs.iloc[-1]['High']):
  print('Open High Strategy ', 'Sell below', dfs[-2]['Low'] )
...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='01/01/2020', to_date='24/09/2021')

df = investpy.get_commodity_historical_data(commodity='Silver', from_date='01/01/2020', to_date='24/09/2021')
