...
df = investpy.commodities.get_commodity_historical_data(stock='ABC',from_date='01/02/2020',to_date='14/08/2020', country = "India")
```


```{python, echo = FALSE}

usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='01/02/2020', to_date='06/10/2021')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='01/02/2020', to_date='06/10/2021')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver Micro',from_date='01/02/2020',to_date='06/10/2021', country = "India")
