...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='01/01/2015', to_date='15/01/2021')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='01/01/2015', to_date='15/01/2021')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver Micro',from_date='01/01/2015',to_date='15/01/2021', country = "India")
```
...
diffdf = df2.diff()
df2['Pos'] = np.where((df2['Volume'] > df2['Volume'].shift(1)) & ((df2['Close'] >= df2['Close'].shift(1))),"Buy","Sell")
print(df2.tail(5))
