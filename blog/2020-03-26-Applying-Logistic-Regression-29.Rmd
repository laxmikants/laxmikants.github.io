...
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='09/10/2019', to_date='24/03/2022')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='09/10/2019', to_date='24/03/2022')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver Micro',from_date='09/10/2019',to_date='24/03/2022', country = "India")
...
if(predict == 1):
    print('Buy at daily: ', (data2_dl.iloc[1,4] + data2_dl.iloc[1,3] + data2_dl.iloc[1,2]  + data2_dl.iloc[1,1]) / 4)
    print('Buy at hourly: ', (data2_hr.iloc[1,4] + data2_hr.iloc[1,3] + data2_hr.iloc[1,2]  + data2_hr.iloc[1,1]) / 4)
else:
    print('Sell at daily: ', (data2_dl.iloc[1,4] + data2_dl.iloc[1,5] + data2_dl.iloc[1,6]  + data2_dl.iloc[1,7]) / 4)
    print('Sell at hourly: ', (data2_hr.iloc[1,4] + data2_hr.iloc[1,5] + data2_hr.iloc[1,6]  + data2_hr.iloc[1,7]) / 4)

if(dfs.iloc[-1]['Open'] == dfs.iloc[-1]['Low']): 
  print('Open Low Strategy ', 'Buy above', dfs.iloc[-2]['High'] )
  print('last Close: ', lclose)


if(dfs.iloc[-1]['Open'] == dfs.iloc[-1]['High']): 
  print('Open High Strategy ', 'Sell below', dfs.iloc[-2]['Low'] )
  print('last Close: ', lclose)
