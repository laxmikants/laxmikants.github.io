...
```{python, echo = FALSE}
usdinr = investpy.get_currency_cross_historical_data(currency_cross='USD/INR', from_date='01/1/2019', to_date='21/12/2020')

dfusd = investpy.get_commodity_historical_data(commodity='Silver', from_date='01/12/2019', to_date='21/12/2020')

df = investpy.commodities.get_commodity_historical_data(commodity='MCX Silver',from_date='01/12/2019',to_date='21/12/2020', country = "India")
