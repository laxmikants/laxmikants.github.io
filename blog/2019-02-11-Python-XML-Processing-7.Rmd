...
The last thing that we are going to look at in this chapter is creating new XML elements by using DOM. In order to do that, we first need to define a new person element.
