...
df = investpy.get_stock_historical_data(stock='VODA', country='India',from_date='01/01/2015', to_date='12/06/2021')
df['Open'] = df['Open'] * 10
...
data1 = investpy.moving_averages(name='VODA', country='India', product_type='stock', interval='daily')
print(data1.head())
