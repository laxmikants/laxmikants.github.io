...
A time series is a series of observations collected at some time intervals. 
Time is an important component here. The observations collected are dependent on the time at which it is collected.
The sale items in a retail store like Walmart will be a time series. The sale could be at daily level or weekly level. 
The number of people flying from Bangalore to delhi on daily basis is a time series. 
...
Time component is important. The time series is dependent on the time. However a normal series say 1, 2, 3...100 has no time component to it. 
...
The function ts is used to create time-series objects. As.ts and is.ts coerce an object to a time-series and 
...
```{r,echo=TRUE}
require(graphics)
ts(1:10, frequency = 4, start = c(1959,2)) # 2nd qurter of 1959
...
The number of observations per unit of time is known as frequency.
...
3205,3253,3221,3192,3170,3240,3345,3480,3750,3725,3800,4000), .Tsp = c(2008, 2019.91666666667, 12), class = "ts")
