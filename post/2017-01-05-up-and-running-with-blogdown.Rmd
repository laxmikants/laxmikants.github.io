---
title: Websites with blogdown
author: Laxmikant 
description: "up-and-running-with-blogdown"
slug: up-and-running-with-blogdown
date: 2017-01-05
lastmod: 2017-01-05
categories: ["blogdown"]
tags: ["Blogdown","Github","Netlify"]
summary: A guide to getting up and running with blogdown, GitHub, and Netlify
subtitle: Building websites with blogdown
lua:
  image:
    url: "/img/cover.png"
    width: 800
...
{{% /alert %}}
    * If you want to host your site as a [GitHub Page](https://pages.github.com), you should name your repository `yourgithubusername.github.io` (so mine would have been `laxmikants.github.io`).
    


![Screenshot above: Creating a new repository in GitHub](/img/github-new-repo.png)
...
```
git clone https://github.com/laxmikants/laxmikants.git
```

And this is what printed to my terminal window:

```
Cloning into 'laxmikants'...
...
![Screenshot above: Creating a new project in an existing directory in RStudio](/img/r-project-existing-directory.png)
...
* You can also view [my `config.toml` file](https://github.com/laxmikants/laxmikants/blob/master/config.toml)
